...
# Find the start of the div that contains 'Guardar Supuestos'
match = re.search(r'<div class=\"d-flex justify-content-center mt-5 mb-4\">[\s\S]*?Guardar Supuestos', text)
if match:
    html_section = '''
