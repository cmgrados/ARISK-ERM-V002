                    ...
                    const budgetDataJson7 = 'VAR';
                    const histDataJson7 = 'VAR';
                    const projectionYearsCount = parseInt('VAR');
                    const projectionStartYear = parseInt('VAR'.replace(/,/g, ''));
        ...
        if (endDisplayEl) endDisplayEl.innerText = projectionStartYear + projectionYearsCount - 1;
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        if (data && data.income_statement) {
                            ...
                            const projYearRaw = 'VAR'.replace(/,/g, '');
