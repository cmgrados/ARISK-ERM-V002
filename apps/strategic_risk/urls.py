...
urlpatterns = [
    ...
    path('seguimiento/', RedirectView.as_view(url='/estrategico/ejecucion-metas/', permanent=False)),
    path('elaboracion-poa/', views.elaboracion_poa, name='elaboracion_poa'),
    path('ponderacion-poa/', views.ponderacion_poa, name='ponderacion_poa'),
    path('ejecucion-metas/', views.ejecucion_metas, name='ejecucion_metas'),
    path('avance-ejecucion-metas-fechas/', views.avance_ejecucion_metas_fechas, name='avance_ejecucion_metas_fechas'),
    path('avance-ejecucion-poa-proyectos/', views.avance_ejecucion_poa_proyectos, name='avance_ejecucion_poa_proyectos'),
    ...
    path('ajax/save-ponderacion-poa/', views.save_ponderacion_poa, name='save_ponderacion_poa'),
