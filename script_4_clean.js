    ...
    document.addEventListener('DOMContentLoaded', function() {
        const projStartYearInput = document.getElementById('VAR');
        const projYearsInput = document.getElementById('VAR');
        ...
        URL
        try {
            const instAssump = JSON.parse('VAR');
        ...
        function lockStep6() {
            ...
            const doLock = () => {
                ...
                $.ajax({
                    ...
                    headers: { "X-CSRFToken": document.querySelector('[name=csrfmiddlewaretoken]') ? document.querySelector('[name=csrfmiddlewaretoken]').value : 'VAR' },
            ...
            if (window.costParams || window.yieldParams) {
                ...
                fetch(`URL`, {
                    ...
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRFToken': document.querySelector('[name=csrfmiddlewaretoken]') ? document.querySelector('[name=csrfmiddlewaretoken]').value : 'VAR'
                    },
...
window.handleWizardContinue = function(url) {
    ...
    URL
    const saveAssumptionsUrl = "URL";
    URL
    const saveAssumptionsUrl = "";
    URL

    if ((window.costParams || window.yieldParams) && saveAssumptionsUrl) {
        const payload = {};
